...
import { SocketResponse, WebSocketOptions } from '../_models';
...
export class WebSocketService {
  ...
  private configuration: StompConfig = {
  ...
  private connect = () => {
    ...
    this.stompService.stompClient.configure(this.configuration);
